    ...
    >
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-24 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:1/2">
          ...
          {/* education */}
          <div className="flex flex-col gap-12 justify-center pb-32" ref={educationRef}>
            {/* edu title */}
            <motion.h1 
              initial={{x:"-300px"}}
            ...
            <motion.div
              ...
              <div className="flex justify-between h-48">
                ...
                {/* job role */}
                  ...
                  {/* job company */}
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">Kannur University</div></div>
              </div>
              {/* exp list item 3 */}
              <div className="flex justify-between h-48">
                {/* left */}
